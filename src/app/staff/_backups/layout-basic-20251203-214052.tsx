      ...
      <aside className="w-64 bg-[--navy] text-white fixed inset-y-0 left-0 z-50">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-white/10">
          ...
          <div className="flex items-center gap-3">
            {/* UserButton - shows placeholder in E2E test mode when Clerk session unavailable */}
            <div data-clerk-user-button className="w-8 h-8 rounded-full bg-[--sage] flex items-center justify-center text-sm font-medium text-white">
              <UserButton 
                appearance={{
                  elements: {
              ...
              />
              {/* Fallback content visible when UserButton doesn't render (E2E tests) */}
              <span className="clerk-fallback">TS</span>
            </div>
            <div className="flex-1 min-w-0">
