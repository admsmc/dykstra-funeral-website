...
describe('Use Case 7.2: Inventory Cycle Count', () => {
  describe('Happy Paths', () => {
      ...
      const mockInventoryPort: GoInventoryPortService = {
        getBalance: () =>
          Effect.succeed({
            ...
            quantityOnHand: 50, // Same as physical count
      ...
      const mockInventoryPort: GoInventoryPortService = {
        getBalance: () =>
          Effect.succeed({
            ...
            locationId: 'loc-main',
            locationName: 'Main Warehouse',
            quantityOnHand: 45, // System has less than physical
      ...
      const mockInventoryPort: GoInventoryPortService = {
        getBalance: () =>
          Effect.succeed({
            ...
            locationId: 'loc-main',
            locationName: 'Main Warehouse',
            quantityOnHand: 55, // System has more than physical
    ...
    it('should handle lot-tracked inventory', async () => {
      ...
      const mockInventoryPort: GoInventoryPortService = {
        getBalance: (cmd) => {
          expect(cmd.lotNumber).toBe('LOT-2024-001');
          return Effect.succeed({
            itemId: 'item-123',
            itemName: 'Casket Model A',
            itemSku: 'CASK-001',
      ...
      const mockInventoryPort: GoInventoryPortService = {
        getBalance: () =>
          Effect.succeed({
            ...
            locationId: 'loc-main',
            locationName: 'Main Warehouse',
            quantityOnHand: 45, // Variance exists
            quantityAvailable: 40,
            quantityReserved: 5,
            lotNumber: undefined,
            unitCost: 1500,
