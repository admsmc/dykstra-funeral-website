...
const toDomain = async (prismaCase: any): Promise<Case> => {
  ...
  return new Case({
    ...
    arrangements,
    goContractId: prismaCase.goContractId,
    glJournalEntryId: prismaCase.glJournalEntryId,
    revenueAmount: prismaCase.revenueAmount,
    cogsAmount: prismaCase.cogsAmount,
    cogsJournalEntryId: prismaCase.cogsJournalEntryId,
    inventoryDeliveredAt: prismaCase.inventoryDeliveredAt,
    inventoryDeliveredBy: prismaCase.inventoryDeliveredBy,
    finalizedAt: prismaCase.finalizedAt,
    finalizedBy: prismaCase.finalizedBy,
...
const toPrisma = (case_: Case, validFrom: Date = new Date()) => {
  return {
    ...
    goContractId: case_.goContractId,
    glJournalEntryId: case_.glJournalEntryId,
    revenueAmount: case_.revenueAmount,
    cogsAmount: case_.cogsAmount,
    cogsJournalEntryId: case_.cogsJournalEntryId,
    inventoryDeliveredAt: case_.inventoryDeliveredAt,
    inventoryDeliveredBy: case_.inventoryDeliveredBy,
    finalizedAt: case_.finalizedAt,
    finalizedBy: case_.finalizedBy,
